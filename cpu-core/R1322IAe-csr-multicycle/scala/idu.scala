...
class idu extends Module {
  ...
  //================================IFU输入.bits=============================================
  io.idu_to_exu1.dec1_val.nextpc  := io.ifu_to_idu.bits.inst1_nextpc
  //================================IFU输入.bits=============================================
  ...
  //================================IFU输入.bits=============================================
  io.idu_to_exu2.dec2_val.nextpc  := Mux(final_stall, 0.U(32.W), io.ifu_to_idu.bits.inst2_nextpc)
  //================================IFU输入.bits=============================================

  // ---------- CSR 顶传信号（放入 idu_to_exu1） ----------
  io.idu_to_exu1.is_stall := io.idu_to_ifu.is_stall
  //================================IFU输入.bits=============================================
  io.idu_to_exu1.inst1_pc := io.ifu_to_idu.bits.inst1_pc
  io.idu_to_exu1.inst1    := io.ifu_to_idu.bits.inst1
  //================================IFU输入.bits=============================================
  原打包保留结束 */

  //====================================新增: D/E 单lane打包====================================
  // ---- lane1 ----
  io.idu_to_exu1.bits.op.is_lui    := dec1.io.is_lui
  io.idu_to_exu1.bits.op.is_auipc  := dec1.io.is_auipc
  io.idu_to_exu1.bits.op.is_jal    := dec1.io.is_jal
  io.idu_to_exu1.bits.op.is_jalr   := dec1.io.is_jalr
  io.idu_to_exu1.bits.op.is_beq    := dec1.io.is_beq
  io.idu_to_exu1.bits.op.is_bne    := dec1.io.is_bne
  io.idu_to_exu1.bits.op.is_blt    := dec1.io.is_blt
  io.idu_to_exu1.bits.op.is_bge    := dec1.io.is_bge
  io.idu_to_exu1.bits.op.is_bltu   := dec1.io.is_bltu
  io.idu_to_exu1.bits.op.is_bgeu   := dec1.io.is_bgeu
  io.idu_to_exu1.bits.op.is_lb     := dec1.io.is_lb
  io.idu_to_exu1.bits.op.is_lh     := dec1.io.is_lh
  io.idu_to_exu1.bits.op.is_lw     := dec1.io.is_lw
  io.idu_to_exu1.bits.op.is_lbu    := dec1.io.is_lbu
  io.idu_to_exu1.bits.op.is_lhu    := dec1.io.is_lhu
  io.idu_to_exu1.bits.op.is_sb     := dec1.io.is_sb
  io.idu_to_exu1.bits.op.is_sh     := dec1.io.is_sh
  io.idu_to_exu1.bits.op.is_sw     := dec1.io.is_sw
  io.idu_to_exu1.bits.op.is_addi   := dec1.io.is_addi
  io.idu_to_exu1.bits.op.is_slti   := dec1.io.is_slti
  io.idu_to_exu1.bits.op.is_sltiu  := dec1.io.is_sltiu
  io.idu_to_exu1.bits.op.is_xori   := dec1.io.is_xori
  io.idu_to_exu1.bits.op.is_ori    := dec1.io.is_ori
  io.idu_to_exu1.bits.op.is_andi   := dec1.io.is_andi
  io.idu_to_exu1.bits.op.is_slli   := dec1.io.is_slli
  io.idu_to_exu1.bits.op.is_srli   := dec1.io.is_srli
  io.idu_to_exu1.bits.op.is_srai   := dec1.io.is_srai
  io.idu_to_exu1.bits.op.is_add    := dec1.io.is_add
  io.idu_to_exu1.bits.op.is_sub    := dec1.io.is_sub
  io.idu_to_exu1.bits.op.is_sll    := dec1.io.is_sll
  io.idu_to_exu1.bits.op.is_slt    := dec1.io.is_slt
  io.idu_to_exu1.bits.op.is_sltu   := dec1.io.is_sltu
  io.idu_to_exu1.bits.op.is_xor    := dec1.io.is_xor
  io.idu_to_exu1.bits.op.is_srl    := dec1.io.is_srl
  io.idu_to_exu1.bits.op.is_sra    := dec1.io.is_sra
  io.idu_to_exu1.bits.op.is_or     := dec1.io.is_or
  io.idu_to_exu1.bits.op.is_and    := dec1.io.is_and
  io.idu_to_exu1.bits.op.is_ebreak := dec1.io.is_ebreak
  io.idu_to_exu1.bits.op.is_csrrw  := dec1.io.is_csrrw
  io.idu_to_exu1.bits.op.is_csrrs  := dec1.io.is_csrrs
  io.idu_to_exu1.bits.op.is_csrrc  := dec1.io.is_csrrc
  io.idu_to_exu1.bits.op.is_csrrwi := dec1.io.is_csrrwi
  io.idu_to_exu1.bits.op.is_csrrsi := dec1.io.is_csrrsi
  io.idu_to_exu1.bits.op.is_csrrci := dec1.io.is_csrrci
  io.idu_to_exu1.bits.op.is_ecall  := dec1.io.is_ecall
  io.idu_to_exu1.bits.op.is_mret   := dec1.io.is_mret
  io.idu_to_exu1.bits.imm      := dec1.io.imm
  io.idu_to_exu1.bits.rs1_val  := io.grf_to_idu.dec1_value.inst1rs1_value
  io.idu_to_exu1.bits.rs2_val  := io.grf_to_idu.dec1_value.inst1rs2_value
  io.idu_to_exu1.bits.nextpc   := io.ifu_to_idu.bits.inst1_nextpc
  io.idu_to_exu1.bits.rd       := dec1.io.rd
  io.idu_to_exu1.bits.is_stall := io.idu_to_ifu.is_stall
  io.idu_to_exu1.bits.inst1_pc := io.ifu_to_idu.bits.inst1_pc
  io.idu_to_exu1.bits.inst1    := io.ifu_to_idu.bits.inst1
  /* 原 valid 保留
  io.idu_to_exu1.valid         := true.B
  原 valid 保留结束 */
  ...
  // ---- lane2 ----
  io.idu_to_exu2.bits.op.is_lui    := Mux(final_stall, false.B, dec2.io.is_lui)
  io.idu_to_exu2.bits.op.is_auipc  := Mux(final_stall, false.B, dec2.io.is_auipc)
  io.idu_to_exu2.bits.op.is_jal    := Mux(final_stall, false.B, dec2.io.is_jal)
  io.idu_to_exu2.bits.op.is_jalr   := Mux(final_stall, false.B, dec2.io.is_jalr)
  io.idu_to_exu2.bits.op.is_beq    := Mux(final_stall, false.B, dec2.io.is_beq)
  io.idu_to_exu2.bits.op.is_bne    := Mux(final_stall, false.B, dec2.io.is_bne)
  io.idu_to_exu2.bits.op.is_blt    := Mux(final_stall, false.B, dec2.io.is_blt)
  io.idu_to_exu2.bits.op.is_bge    := Mux(final_stall, false.B, dec2.io.is_bge)
  io.idu_to_exu2.bits.op.is_bltu   := Mux(final_stall, false.B, dec2.io.is_bltu)
  io.idu_to_exu2.bits.op.is_bgeu   := Mux(final_stall, false.B, dec2.io.is_bgeu)
  io.idu_to_exu2.bits.op.is_lb     := Mux(final_stall, false.B, dec2.io.is_lb)
  io.idu_to_exu2.bits.op.is_lh     := Mux(final_stall, false.B, dec2.io.is_lh)
  io.idu_to_exu2.bits.op.is_lw     := Mux(final_stall, false.B, dec2.io.is_lw)
  io.idu_to_exu2.bits.op.is_lbu    := Mux(final_stall, false.B, dec2.io.is_lbu)
  io.idu_to_exu2.bits.op.is_lhu    := Mux(final_stall, false.B, dec2.io.is_lhu)
  io.idu_to_exu2.bits.op.is_sb     := Mux(final_stall, false.B, dec2.io.is_sb)
  io.idu_to_exu2.bits.op.is_sh     := Mux(final_stall, false.B, dec2.io.is_sh)
  io.idu_to_exu2.bits.op.is_sw     := Mux(final_stall, false.B, dec2.io.is_sw)
  io.idu_to_exu2.bits.op.is_addi   := Mux(final_stall, false.B, dec2.io.is_addi)
  io.idu_to_exu2.bits.op.is_slti   := Mux(final_stall, false.B, dec2.io.is_slti)
  io.idu_to_exu2.bits.op.is_sltiu  := Mux(final_stall, false.B, dec2.io.is_sltiu)
  io.idu_to_exu2.bits.op.is_xori   := Mux(final_stall, false.B, dec2.io.is_xori)
  io.idu_to_exu2.bits.op.is_ori    := Mux(final_stall, false.B, dec2.io.is_ori)
  io.idu_to_exu2.bits.op.is_andi   := Mux(final_stall, false.B, dec2.io.is_andi)
  io.idu_to_exu2.bits.op.is_slli   := Mux(final_stall, false.B, dec2.io.is_slli)
  io.idu_to_exu2.bits.op.is_srli   := Mux(final_stall, false.B, dec2.io.is_srli)
  io.idu_to_exu2.bits.op.is_srai   := Mux(final_stall, false.B, dec2.io.is_srai)
  io.idu_to_exu2.bits.op.is_add    := Mux(final_stall, false.B, dec2.io.is_add)
  io.idu_to_exu2.bits.op.is_sub    := Mux(final_stall, false.B, dec2.io.is_sub)
  io.idu_to_exu2.bits.op.is_sll    := Mux(final_stall, false.B, dec2.io.is_sll)
  io.idu_to_exu2.bits.op.is_slt    := Mux(final_stall, false.B, dec2.io.is_slt)
  io.idu_to_exu2.bits.op.is_sltu   := Mux(final_stall, false.B, dec2.io.is_sltu)
  io.idu_to_exu2.bits.op.is_xor    := Mux(final_stall, false.B, dec2.io.is_xor)
  io.idu_to_exu2.bits.op.is_srl    := Mux(final_stall, false.B, dec2.io.is_srl)
  io.idu_to_exu2.bits.op.is_sra    := Mux(final_stall, false.B, dec2.io.is_sra)
  io.idu_to_exu2.bits.op.is_or     := Mux(final_stall, false.B, dec2.io.is_or)
  io.idu_to_exu2.bits.op.is_and    := Mux(final_stall, false.B, dec2.io.is_and)
  io.idu_to_exu2.bits.op.is_ebreak := Mux(final_stall, false.B, dec2.io.is_ebreak)
  io.idu_to_exu2.bits.op.is_csrrw  := Mux(final_stall, false.B, dec2.io.is_csrrw)
  io.idu_to_exu2.bits.op.is_csrrs  := Mux(final_stall, false.B, dec2.io.is_csrrs)
  io.idu_to_exu2.bits.op.is_csrrc  := Mux(final_stall, false.B, dec2.io.is_csrrc)
  io.idu_to_exu2.bits.op.is_csrrwi := Mux(final_stall, false.B, dec2.io.is_csrrwi)
  io.idu_to_exu2.bits.op.is_csrrsi := Mux(final_stall, false.B, dec2.io.is_csrrsi)
  io.idu_to_exu2.bits.op.is_csrrci := Mux(final_stall, false.B, dec2.io.is_csrrci)
  io.idu_to_exu2.bits.op.is_ecall  := Mux(final_stall, false.B, dec2.io.is_ecall)
  io.idu_to_exu2.bits.op.is_mret   := Mux(final_stall, false.B, dec2.io.is_mret)
  io.idu_to_exu2.bits.imm      := Mux(final_stall, 0.U(32.W), dec2.io.imm)
  io.idu_to_exu2.bits.rs1_val  := Mux(final_stall, 0.U(32.W), io.grf_to_idu.dec2_value.inst2rs1_value)
  io.idu_to_exu2.bits.rs2_val  := Mux(final_stall, 0.U(32.W), io.grf_to_idu.dec2_value.inst2rs2_value)
  io.idu_to_exu2.bits.nextpc   := Mux(final_stall, 0.U(32.W), io.ifu_to_idu.bits.inst2_nextpc)
  io.idu_to_exu2.bits.rd       := Mux(final_stall, 0.U(5.W), dec2.io.rd)
  io.idu_to_exu2.bits.is_stall := false.B
  io.idu_to_exu2.bits.inst1_pc := 0.U
  io.idu_to_exu2.bits.inst1    := 0.U
  /* 原 valid 保留
  io.idu_to_exu2.valid         := true.B
  原 valid 保留结束 */
  //====================================新增: valid 随输入====================================
  io.idu_to_exu2.valid         := io.ifu_to_idu.valid
  //====================================新增: valid 随输入====================================
  //====================================新增: D/E 单lane打包====================================
