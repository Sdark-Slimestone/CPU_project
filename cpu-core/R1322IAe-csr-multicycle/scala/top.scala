...
class top extends Module {
  ...
  // ===================== IFU ↔ IDU =====================
  StageConnect(ifu.io.ifu_to_idu, idu.io.ifu_to_idu)
  ifu.io.idu_to_ifu <> idu.io.idu_to_ifu

  //====================================新增: 多周期控制信号====================================
  ifu.io.ctrl.capture_stall    := idu.io.ifu_to_idu.valid   // IDU 处理该包那拍
  ifu.io.ctrl.capture_redirect := exu1.io.idu_to_exu1.valid // EXU 处理该包那拍
  ifu.io.ctrl.done             := wbu.io.lsu_to_wbu_1.valid // WBU 处理该包那拍(最后拍)
  //====================================新增: 多周期控制信号====================================
  ...
  // ===================== IDU → [D/E桥] → EXU1/EXU2 =====================
  StageConnect(idu.io.idu_to_exu1, exu1.io.idu_to_exu1)
  StageConnect(idu.io.idu_to_exu2, exu2.io.idu_to_exu1)
  ...
  // ===================== EXU1/2 → [E/M桥] → LSU1/2 =====================
  StageConnect(exu1.io.exu_to_lsu, lsu1.io.exu_to_lsu)
  StageConnect(exu2.io.exu_to_lsu, lsu2.io.exu_to_lsu)

  // ===================== LSU1/2 → [M/W桥] → WBU =====================
  StageConnect(lsu1.io.lsu_to_wbu, wbu.io.lsu_to_wbu_1)
  StageConnect(lsu2.io.lsu_to_wbu, wbu.io.lsu_to_wbu_2)
