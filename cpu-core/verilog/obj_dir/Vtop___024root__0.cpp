...
void Vtop___024root____Vdpiimwrap_top__DOT__instMem__DOT__inst__DOT__pmem_read_TOP(IData/*31:0*/ addr, IData/*31:0*/ &pmem_read__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtop___024root____Vdpiimwrap_top__DOT__instMem__DOT__inst__DOT__pmem_read_TOP\n"); );
    // Body
    int addr__Vcvt;
    addr__Vcvt = addr;
...
void Vtop___024root____Vdpiimwrap_top__DOT__instMem__DOT__inst__DOT__pmem_write_TOP(IData/*31:0*/ addr, IData/*31:0*/ data, CData/*7:0*/ mask) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtop___024root____Vdpiimwrap_top__DOT__instMem__DOT__inst__DOT__pmem_write_TOP\n"); );
    // Body
    int addr__Vcvt;
    addr__Vcvt = addr;
    int data__Vcvt;
...
void Vtop___024root____Vdpiimwrap_top__DOT__instMem__DOT__inst__DOT__sim_finish_TOP() {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtop___024root____Vdpiimwrap_top__DOT__instMem__DOT__inst__DOT__sim_finish_TOP\n"); );
    // Body
    sim_finish();
}
...
void Vtop___024root___nba_sequent__TOP__0(Vtop___024root* vlSelf) {
    ...
    Vtop___024root____Vdpiimwrap_top__DOT__instMem__DOT__inst__DOT__pmem_read_TOP(vlSelfRef.top__DOT__ifu__DOT__pcReg, vlSelfRef.__Vfunc_top__DOT__instMem__DOT__inst__DOT__pmem_read__0__Vfuncout);
    vlSelfRef.top__DOT___instMem_rdata = vlSelfRef.__Vfunc_top__DOT__instMem__DOT__inst__DOT__pmem_read__0__Vfuncout;
    ...
    if (vlSelfRef.top__DOT___lsu_io_dmemWen) {
        Vtop___024root____Vdpiimwrap_top__DOT__instMem__DOT__inst__DOT__pmem_write_TOP(vlSelfRef.top__DOT___lsu_io_dmemAddr, 
    ...
    vlSelfRef.top__DOT___dataMem_rdata = ((IData)(vlSelfRef.top__DOT___lsu_io_dmemRen)
                                           ? ([&]() {
                Vtop___024root____Vdpiimwrap_top__DOT__instMem__DOT__inst__DOT__pmem_read_TOP(vlSelfRef.top__DOT___lsu_io_dmemAddr, vlSelfRef.__Vfunc_top__DOT__dataMem__DOT__inst__DOT__pmem_read__2__Vfuncout);
            }(), vlSelfRef.__Vfunc_top__DOT__dataMem__DOT__inst__DOT__pmem_read__2__Vfuncout)
                                           : 0U);
