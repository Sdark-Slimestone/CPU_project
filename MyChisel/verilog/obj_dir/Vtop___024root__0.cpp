...
void Vtop___024root___nba_sequent__TOP__0(Vtop___024root* vlSelf) {
    ...
    vlSelfRef.io_debug_lsu_wmask = ((IData)(vlSelfRef.top__DOT___idu_io_is_sw)
                                    ...
                                    ((IData)(vlSelfRef.top__DOT___idu_io_is_sb)
                                      ...
                                      : 0U));
    if (VL_UNLIKELY((vlSelfRef.top__DOT___lsu_io_dmemWen))) {
        VL_WRITEF_NX("[DPI] wen=1, calling pmem_write(addr=0x%x, data=0x%x, mask=0x%x)\n[DPI] WRITE: addr=0x%x, data=0x%x, mask=0x%x\n",0,
                     32,vlSelfRef.top__DOT___lsu_io_dmemAddr,
                     32,vlSelfRef.top__DOT___grf_io_rs2out,
                     4,((IData)(vlSelfRef.top__DOT___idu_io_is_sw)
                         ? 0x0000000fU : ((IData)(vlSelfRef.top__DOT___idu_io_is_sb)
                                           ? (0x0000000fU 
                                              & ((IData)(1U) 
                                                 << 
                                                 (3U 
                                           ...
                                           ? (0x0000000fU 
                                              & ((IData)(1U) 
                                                 ...
                                                 (3U 
                                                  & vlSelfRef.top__DOT___lsu_io_dmemAddr)))
                                           : 0U)));
        Vtop___024root____Vdpiimwrap_top__DOT__instMem__DOT__pmem_write_TOP(vlSelfRef.top__DOT___lsu_io_dmemAddr, vlSelfRef.top__DOT___grf_io_rs2out, 
                                                                            ((IData)(vlSelfRef.top__DOT___idu_io_is_sw)
                                                                              ? 0x0000000fU
                                                                              : 
                                                                             ((IData)(vlSelfRef.top__DOT___idu_io_is_sb)
