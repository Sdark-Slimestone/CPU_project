...
void VsvsimTestbench::getBitWidthImpl_input_bits_value2(int* value) {
    ...
    static int __Vfuncnum = -1;
    if (VL_UNLIKELY(__Vfuncnum == -1)) {
        __Vfuncnum = Verilated::exportFuncNum("getBitWidthImpl_input_bits_value2");
    }
    const VerilatedScope* const __Vscopep = Verilated::dpiScope();
    VsvsimTestbench__Vcb_getBitWidthImpl_input_bits_value2_t __Vcb = reinterpret_cast<VsvsimTestbench__Vcb_getBitWidthImpl_input_bits_value2_t>(VerilatedScope::exportFind(__Vscopep, __Vfuncnum));
    (*__Vcb)((VsvsimTestbench__Syms*)(__Vscopep->symsp()), value__Vcvt);
    *value = value__Vcvt;
}
...
void VsvsimTestbench::setBitsImpl_input_bits_value2(const svBitVecVal* value_input_bits_value2) {
    ...
    static int __Vfuncnum = -1;
    if (VL_UNLIKELY(__Vfuncnum == -1)) {
        __Vfuncnum = Verilated::exportFuncNum("setBitsImpl_input_bits_value2");
    }
    const VerilatedScope* const __Vscopep = Verilated::dpiScope();
    VsvsimTestbench__Vcb_setBitsImpl_input_bits_value2_t __Vcb = reinterpret_cast<VsvsimTestbench__Vcb_setBitsImpl_input_bits_value2_t>(VerilatedScope::exportFind(__Vscopep, __Vfuncnum));
    VL_SET_S_SVBV(16, value_input_bits_value2__Vcvt, value_input_bits_value2 + 0);
...
void VsvsimTestbench::getBitsImpl_input_bits_value2(svBitVecVal* value_input_bits_value2) {
    ...
    static int __Vfuncnum = -1;
    if (VL_UNLIKELY(__Vfuncnum == -1)) {
        __Vfuncnum = Verilated::exportFuncNum("getBitsImpl_input_bits_value2");
    }
    const VerilatedScope* const __Vscopep = Verilated::dpiScope();
    VsvsimTestbench__Vcb_getBitsImpl_input_bits_value2_t __Vcb = reinterpret_cast<VsvsimTestbench__Vcb_getBitsImpl_input_bits_value2_t>(VerilatedScope::exportFind(__Vscopep, __Vfuncnum));
    (*__Vcb)((VsvsimTestbench__Syms*)(__Vscopep->symsp()), value_input_bits_value2__Vcvt);
...
void VsvsimTestbench::getBitWidthImpl_input_bits_value1(int* value) {
    ...
    static int __Vfuncnum = -1;
    if (VL_UNLIKELY(__Vfuncnum == -1)) {
        __Vfuncnum = Verilated::exportFuncNum("getBitWidthImpl_input_bits_value1");
    }
    const VerilatedScope* const __Vscopep = Verilated::dpiScope();
    VsvsimTestbench__Vcb_getBitWidthImpl_input_bits_value1_t __Vcb = reinterpret_cast<VsvsimTestbench__Vcb_getBitWidthImpl_input_bits_value1_t>(VerilatedScope::exportFind(__Vscopep, __Vfuncnum));
    (*__Vcb)((VsvsimTestbench__Syms*)(__Vscopep->symsp()), value__Vcvt);
    *value = value__Vcvt;
}
...
void VsvsimTestbench::setBitsImpl_input_bits_value1(const svBitVecVal* value_input_bits_value1) {
    ...
    static int __Vfuncnum = -1;
    if (VL_UNLIKELY(__Vfuncnum == -1)) {
        __Vfuncnum = Verilated::exportFuncNum("setBitsImpl_input_bits_value1");
    }
    const VerilatedScope* const __Vscopep = Verilated::dpiScope();
    VsvsimTestbench__Vcb_setBitsImpl_input_bits_value1_t __Vcb = reinterpret_cast<VsvsimTestbench__Vcb_setBitsImpl_input_bits_value1_t>(VerilatedScope::exportFind(__Vscopep, __Vfuncnum));
    VL_SET_S_SVBV(16, value_input_bits_value1__Vcvt, value_input_bits_value1 + 0);
...
void VsvsimTestbench::getBitsImpl_input_bits_value1(svBitVecVal* value_input_bits_value1) {
    ...
    static int __Vfuncnum = -1;
    if (VL_UNLIKELY(__Vfuncnum == -1)) {
        __Vfuncnum = Verilated::exportFuncNum("getBitsImpl_input_bits_value1");
    }
    const VerilatedScope* const __Vscopep = Verilated::dpiScope();
    VsvsimTestbench__Vcb_getBitsImpl_input_bits_value1_t __Vcb = reinterpret_cast<VsvsimTestbench__Vcb_getBitsImpl_input_bits_value1_t>(VerilatedScope::exportFind(__Vscopep, __Vfuncnum));
    (*__Vcb)((VsvsimTestbench__Syms*)(__Vscopep->symsp()), value_input_bits_value1__Vcvt);
...
void VsvsimTestbench::getBitWidthImpl_input_valid(int* value) {
    ...
    static int __Vfuncnum = -1;
    if (VL_UNLIKELY(__Vfuncnum == -1)) {
        __Vfuncnum = Verilated::exportFuncNum("getBitWidthImpl_input_valid");
    }
    const VerilatedScope* const __Vscopep = Verilated::dpiScope();
    VsvsimTestbench__Vcb_getBitWidthImpl_input_valid_t __Vcb = reinterpret_cast<VsvsimTestbench__Vcb_getBitWidthImpl_input_valid_t>(VerilatedScope::exportFind(__Vscopep, __Vfuncnum));
    (*__Vcb)((VsvsimTestbench__Syms*)(__Vscopep->symsp()), value__Vcvt);
    *value = value__Vcvt;
}
...
void VsvsimTestbench::setBitsImpl_input_valid(const svBitVecVal* value_input_valid) {
    ...
    static int __Vfuncnum = -1;
    if (VL_UNLIKELY(__Vfuncnum == -1)) {
        __Vfuncnum = Verilated::exportFuncNum("setBitsImpl_input_valid");
    }
    const VerilatedScope* const __Vscopep = Verilated::dpiScope();
    VsvsimTestbench__Vcb_setBitsImpl_input_valid_t __Vcb = reinterpret_cast<VsvsimTestbench__Vcb_setBitsImpl_input_valid_t>(VerilatedScope::exportFind(__Vscopep, __Vfuncnum));
    VL_SET_C_SVBV(1, value_input_valid__Vcvt, value_input_valid + 0);
...
void VsvsimTestbench::getBitsImpl_input_valid(svBitVecVal* value_input_valid) {
    ...
    static int __Vfuncnum = -1;
    if (VL_UNLIKELY(__Vfuncnum == -1)) {
        __Vfuncnum = Verilated::exportFuncNum("getBitsImpl_input_valid");
    }
    const VerilatedScope* const __Vscopep = Verilated::dpiScope();
    VsvsimTestbench__Vcb_getBitsImpl_input_valid_t __Vcb = reinterpret_cast<VsvsimTestbench__Vcb_getBitsImpl_input_valid_t>(VerilatedScope::exportFind(__Vscopep, __Vfuncnum));
    (*__Vcb)((VsvsimTestbench__Syms*)(__Vscopep->symsp()), value_input_valid__Vcvt);
...
void VsvsimTestbench::getBitWidthImpl_input_ready(int* value) {
    ...
    static int __Vfuncnum = -1;
    if (VL_UNLIKELY(__Vfuncnum == -1)) {
        __Vfuncnum = Verilated::exportFuncNum("getBitWidthImpl_input_ready");
    }
    const VerilatedScope* const __Vscopep = Verilated::dpiScope();
    VsvsimTestbench__Vcb_getBitWidthImpl_input_ready_t __Vcb = reinterpret_cast<VsvsimTestbench__Vcb_getBitWidthImpl_input_ready_t>(VerilatedScope::exportFind(__Vscopep, __Vfuncnum));
    (*__Vcb)((VsvsimTestbench__Syms*)(__Vscopep->symsp()), value__Vcvt);
    *value = value__Vcvt;
}
...
void VsvsimTestbench::getBitsImpl_input_ready(svBitVecVal* value_input_ready) {
    ...
    static int __Vfuncnum = -1;
    if (VL_UNLIKELY(__Vfuncnum == -1)) {
        __Vfuncnum = Verilated::exportFuncNum("getBitsImpl_input_ready");
    }
    const VerilatedScope* const __Vscopep = Verilated::dpiScope();
    VsvsimTestbench__Vcb_getBitsImpl_input_ready_t __Vcb = reinterpret_cast<VsvsimTestbench__Vcb_getBitsImpl_input_ready_t>(VerilatedScope::exportFind(__Vscopep, __Vfuncnum));
...
void VsvsimTestbench::getBitWidthImpl_output_bits_gcd(int* value) {
    ...
    static int __Vfuncnum = -1;
    if (VL_UNLIKELY(__Vfuncnum == -1)) {
        __Vfuncnum = Verilated::exportFuncNum("getBitWidthImpl_output_bits_gcd");
    }
    const VerilatedScope* const __Vscopep = Verilated::dpiScope();
    VsvsimTestbench__Vcb_getBitWidthImpl_output_bits_gcd_t __Vcb = reinterpret_cast<VsvsimTestbench__Vcb_getBitWidthImpl_output_bits_gcd_t>(VerilatedScope::exportFind(__Vscopep, __Vfuncnum));
    (*__Vcb)((VsvsimTestbench__Syms*)(__Vscopep->symsp()), value__Vcvt);
    *value = value__Vcvt;
}
...
void VsvsimTestbench::getBitsImpl_output_bits_gcd(svBitVecVal* value_output_bits_gcd) {
    ...
    static int __Vfuncnum = -1;
    if (VL_UNLIKELY(__Vfuncnum == -1)) {
        __Vfuncnum = Verilated::exportFuncNum("getBitsImpl_output_bits_gcd");
    }
    const VerilatedScope* const __Vscopep = Verilated::dpiScope();
    VsvsimTestbench__Vcb_getBitsImpl_output_bits_gcd_t __Vcb = reinterpret_cast<VsvsimTestbench__Vcb_getBitsImpl_output_bits_gcd_t>(VerilatedScope::exportFind(__Vscopep, __Vfuncnum));
...
void VsvsimTestbench::getBitWidthImpl_output_bits_value2(int* value) {
    ...
    static int __Vfuncnum = -1;
    if (VL_UNLIKELY(__Vfuncnum == -1)) {
        __Vfuncnum = Verilated::exportFuncNum("getBitWidthImpl_output_bits_value2");
    }
    const VerilatedScope* const __Vscopep = Verilated::dpiScope();
    VsvsimTestbench__Vcb_getBitWidthImpl_output_bits_value2_t __Vcb = reinterpret_cast<VsvsimTestbench__Vcb_getBitWidthImpl_output_bits_value2_t>(VerilatedScope::exportFind(__Vscopep, __Vfuncnum));
    (*__Vcb)((VsvsimTestbench__Syms*)(__Vscopep->symsp()), value__Vcvt);
    *value = value__Vcvt;
}
...
void VsvsimTestbench::getBitsImpl_output_bits_value2(svBitVecVal* value_output_bits_value2) {
    ...
    static int __Vfuncnum = -1;
    if (VL_UNLIKELY(__Vfuncnum == -1)) {
        __Vfuncnum = Verilated::exportFuncNum("getBitsImpl_output_bits_value2");
    }
    const VerilatedScope* const __Vscopep = Verilated::dpiScope();
    VsvsimTestbench__Vcb_getBitsImpl_output_bits_value2_t __Vcb = reinterpret_cast<VsvsimTestbench__Vcb_getBitsImpl_output_bits_value2_t>(VerilatedScope::exportFind(__Vscopep, __Vfuncnum));
...
void VsvsimTestbench::getBitWidthImpl_output_bits_value1(int* value) {
    ...
    static int __Vfuncnum = -1;
    if (VL_UNLIKELY(__Vfuncnum == -1)) {
        __Vfuncnum = Verilated::exportFuncNum("getBitWidthImpl_output_bits_value1");
    }
    const VerilatedScope* const __Vscopep = Verilated::dpiScope();
    VsvsimTestbench__Vcb_getBitWidthImpl_output_bits_value1_t __Vcb = reinterpret_cast<VsvsimTestbench__Vcb_getBitWidthImpl_output_bits_value1_t>(VerilatedScope::exportFind(__Vscopep, __Vfuncnum));
    (*__Vcb)((VsvsimTestbench__Syms*)(__Vscopep->symsp()), value__Vcvt);
    *value = value__Vcvt;
}
...
void VsvsimTestbench::getBitsImpl_output_bits_value1(svBitVecVal* value_output_bits_value1) {
    ...
    static int __Vfuncnum = -1;
    if (VL_UNLIKELY(__Vfuncnum == -1)) {
        __Vfuncnum = Verilated::exportFuncNum("getBitsImpl_output_bits_value1");
    }
    const VerilatedScope* const __Vscopep = Verilated::dpiScope();
    VsvsimTestbench__Vcb_getBitsImpl_output_bits_value1_t __Vcb = reinterpret_cast<VsvsimTestbench__Vcb_getBitsImpl_output_bits_value1_t>(VerilatedScope::exportFind(__Vscopep, __Vfuncnum));
...
void VsvsimTestbench::getBitWidthImpl_output_valid(int* value) {
    ...
    static int __Vfuncnum = -1;
    if (VL_UNLIKELY(__Vfuncnum == -1)) {
        __Vfuncnum = Verilated::exportFuncNum("getBitWidthImpl_output_valid");
    }
    const VerilatedScope* const __Vscopep = Verilated::dpiScope();
    VsvsimTestbench__Vcb_getBitWidthImpl_output_valid_t __Vcb = reinterpret_cast<VsvsimTestbench__Vcb_getBitWidthImpl_output_valid_t>(VerilatedScope::exportFind(__Vscopep, __Vfuncnum));
    (*__Vcb)((VsvsimTestbench__Syms*)(__Vscopep->symsp()), value__Vcvt);
    *value = value__Vcvt;
}
...
void VsvsimTestbench::getBitsImpl_output_valid(svBitVecVal* value_output_valid) {
    ...
    static int __Vfuncnum = -1;
    if (VL_UNLIKELY(__Vfuncnum == -1)) {
        __Vfuncnum = Verilated::exportFuncNum("getBitsImpl_output_valid");
    }
    const VerilatedScope* const __Vscopep = Verilated::dpiScope();
    VsvsimTestbench__Vcb_getBitsImpl_output_valid_t __Vcb = reinterpret_cast<VsvsimTestbench__Vcb_getBitsImpl_output_valid_t>(VerilatedScope::exportFind(__Vscopep, __Vfuncnum));
...
void VsvsimTestbench::getBitWidthImpl_output_ready(int* value) {
    ...
    static int __Vfuncnum = -1;
    if (VL_UNLIKELY(__Vfuncnum == -1)) {
        __Vfuncnum = Verilated::exportFuncNum("getBitWidthImpl_output_ready");
    }
    const VerilatedScope* const __Vscopep = Verilated::dpiScope();
    VsvsimTestbench__Vcb_getBitWidthImpl_output_ready_t __Vcb = reinterpret_cast<VsvsimTestbench__Vcb_getBitWidthImpl_output_ready_t>(VerilatedScope::exportFind(__Vscopep, __Vfuncnum));
    (*__Vcb)((VsvsimTestbench__Syms*)(__Vscopep->symsp()), value__Vcvt);
    *value = value__Vcvt;
}
...
void VsvsimTestbench::setBitsImpl_output_ready(const svBitVecVal* value_output_ready) {
    ...
    static int __Vfuncnum = -1;
    if (VL_UNLIKELY(__Vfuncnum == -1)) {
        __Vfuncnum = Verilated::exportFuncNum("setBitsImpl_output_ready");
    }
    const VerilatedScope* const __Vscopep = Verilated::dpiScope();
    VsvsimTestbench__Vcb_setBitsImpl_output_ready_t __Vcb = reinterpret_cast<VsvsimTestbench__Vcb_setBitsImpl_output_ready_t>(VerilatedScope::exportFind(__Vscopep, __Vfuncnum));
    VL_SET_C_SVBV(1, value_output_ready__Vcvt, value_output_ready + 0);
...
void VsvsimTestbench::getBitsImpl_output_ready(svBitVecVal* value_output_ready) {
    ...
    static int __Vfuncnum = -1;
    if (VL_UNLIKELY(__Vfuncnum == -1)) {
        __Vfuncnum = Verilated::exportFuncNum("getBitsImpl_output_ready");
    }
    const VerilatedScope* const __Vscopep = Verilated::dpiScope();
    VsvsimTestbench__Vcb_getBitsImpl_output_ready_t __Vcb = reinterpret_cast<VsvsimTestbench__Vcb_getBitsImpl_output_ready_t>(VerilatedScope::exportFind(__Vscopep, __Vfuncnum));
    (*__Vcb)((VsvsimTestbench__Syms*)(__Vscopep->symsp()), value_output_ready__Vcvt);
